...
const VerifiyEmail = () => {
    ...
    const handleSendOTP = () => {
        ...
        emailBox.classList.remove("flex");
            ...
            <section className="text-gray-400 bg-gray-900 body-font min-h-[79vh]">
                <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    ...
                    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                        ...
                        <form className="flex w-full md:justify-start justify-center items-end verifyEmail" onSubmit={handleSubmit(onSubmitEmail)}>
                            ...
                            <button className="inline-flex text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded text-lg">Send OTP</button>
                        </form>
                            ...
                            <div className="relative mr-4 lg:w-full xl:w-1/2 w-2/4">
                                ...
                                <div className="max-w-md mx-auto">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <button className="inline-flex text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded text-lg" type="button" onClick={onSubmitOtp}>
                                            Verify
                                        </button>
